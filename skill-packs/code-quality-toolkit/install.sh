...
# Code Quality Toolkit Installer
# Installs all code quality, refactoring, and analysis skills
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Code Quality Toolkit Installer${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
if [ $INSTALLED -gt 0 ]; then
    ...
    echo "  /code-smell-detector --help"
    echo "  /code-refactoring-assistant --help"
    echo "  /technical-debt-analyzer --help"
fi
